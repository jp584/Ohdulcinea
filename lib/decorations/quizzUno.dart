...
import '../sprite_sheets/quizz_sprite_sheet.dart';
import '../sprite_sheets/wack_sprite_sheet.dart';


// OBJECTS INHERIT OF GAME DECORATION WITH PLAYER
class QuizzUno extends GameDecoration with Sensor<DonQuijotePlayer>, ObjectCollision, TapGesture{
  ...
  QuizzUno({required Vector2 position}) : // CONSTRUCTURE (SPRITE; POSITION; SIZE)
        super.withSprite(
        //sprite: Sprite.load(Globals.puzzleChestSpriteSheet), // SPRITE OF THE OBJECT
          sprite: QuizzUnoSpriteSheet.chestClosed , // SPRITE OF THE OBJECT
  ...
  Future<void> onLoad() async {
    chestOpen = await QuizzUnoSpriteSheet.chestOpen;
    chestClosed = await QuizzUnoSpriteSheet.chestClosed;
    return super.onLoad();
  }
