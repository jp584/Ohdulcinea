...
import '../sprite_sheets/puzzles_sprite_sheet.dart';


// OBJECTS INHERIT OF GAME DECORATION WITH PLAYER
class PuzzleUno extends GameDecoration with Sensor<DonQuijotePlayer>, ObjectCollision, TapGesture{
  ...
  PuzzleUno({required Vector2 position}) : // CONSTRUCTURE (SPRITE; POSITION; SIZE)
        super.withSprite(
          ...
          sprite: PuzzleUnoSpriteSheet.chestClosed , // SPRITE OF THE OBJECT
  ...
  Future<void> onLoad() async {
    chestOpen = await PuzzleUnoSpriteSheet.chestOpen;
    chestClosed = await PuzzleUnoSpriteSheet.chestClosed;
    return super.onLoad();
  }
